<template>
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden relative min-h-[400px]">
    <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/30">
      ...
      <button @click="fetchWorks" class="text-sm text-[#3b5998] hover:underline flex items-center font-medium">
...
const completeWork = async (work) => {
  ...
  try {
    ...
    // Ubah UI seketika tanpa perlu reload
